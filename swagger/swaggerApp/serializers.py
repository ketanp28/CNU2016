...
class ProductSerializer (serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'code', 'description', 'price', 'category_id', 'category_name','category')
    ...
    def create(self, validated_data):
        ...
        if 'user' in validated_data:
            ...
            if 'address_line' in validated_data['user']:
                UserDetails.objects.filter(company_name=validated_data['user']['company_name']).update(
...
class OrderDetailsSerializer (serializers.ModelSerializer):
    ...
    qty = serializers.IntegerField(source='quantity_ordered',required=False)
